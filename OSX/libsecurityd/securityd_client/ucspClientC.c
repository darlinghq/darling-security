...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationCreate_t__defined)
#define __MIG_check__Reply__authorizationCreate_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationCreate_t(__Reply__authorizationCreate_t *Out0P)
{

	typedef __Reply__authorizationCreate_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1158) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__authorizationCreate_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationCreate */
mig_external kern_return_t ucsp_client_authorizationCreate
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#pragma pack()
...
#ifdef	__MIG_check__Reply__authorizationCreate_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationCreate_t__defined */

	__DeclareSendRpc(1058, "authorizationCreate")

#if	UseStaticTemplates
	const static mach_msg_ool_descriptor_t rightsTemplate = {
		/* addr = */		(void *)0,
		/* size = */		0,
		/* deal = */		FALSE,
		/* copy = */		MACH_MSG_VIRTUAL_COPY,
...
#if	UseStaticTemplates
	const static mach_msg_ool_descriptor_t environmentTemplate = {
		/* addr = */		(void *)0,
		/* size = */		0,
		/* deal = */		FALSE,
		/* copy = */		MACH_MSG_VIRTUAL_COPY,
	...
	InP->rights.address = (void *)(rights);
	InP->rights.size = rightsCnt;
#else	/* UseStaticTemplates */
	InP->rights.address = (void *)(rights);
	InP->rights.size = rightsCnt;
	InP->rights.deallocate =  FALSE;
	InP->rights.copy = MACH_MSG_VIRTUAL_COPY;
	InP->rights.type = MACH_MSG_OOL_DESCRIPTOR;
#endif	/* UseStaticTemplates */

#if	UseStaticTemplates
	InP->environment = environmentTemplate;
	InP->environment.address = (void *)(environment);
	InP->environment.size = environmentCnt;
#else	/* UseStaticTemplates */
	InP->environment.address = (void *)(environment);
	InP->environment.size = environmentCnt;
	InP->environment.deallocate =  FALSE;
	InP->environment.copy = MACH_MSG_VIRTUAL_COPY;
	InP->environment.type = MACH_MSG_OOL_DESCRIPTOR;
#endif	/* UseStaticTemplates */

	InP->NDR = NDR_record;

	InP->rightsCnt = rightsCnt;

	InP->flags = flags;

	InP->environmentCnt = environmentCnt;
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1058, "authorizationCreate")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1058, "authorizationCreate")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationCreate_t__defined)
	check_result = __MIG_check__Reply__authorizationCreate_t((__Reply__authorizationCreate_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationCreate_t__defined) */
	...
	*authorization = Out0P->authorization;
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationRelease_t__defined)
#define __MIG_check__Reply__authorizationRelease_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationRelease_t(__Reply__authorizationRelease_t *Out0P)
{

	typedef __Reply__authorizationRelease_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1159) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__authorizationRelease_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationRelease */
mig_external kern_return_t ucsp_client_authorizationRelease
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#ifdef	__MIG_check__Reply__authorizationRelease_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationRelease_t__defined */

	__DeclareSendRpc(1059, "authorizationRelease")

	InP->NDR = NDR_record;

	InP->authorization = authorization;
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1059, "authorizationRelease")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1059, "authorizationRelease")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationRelease_t__defined)
	check_result = __MIG_check__Reply__authorizationRelease_t((__Reply__authorizationRelease_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationRelease_t__defined) */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationCopyRights_t__defined)
#define __MIG_check__Reply__authorizationCopyRights_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationCopyRights_t(__Reply__authorizationCopyRights_t *Out0P)
{

	typedef __Reply__authorizationCopyRights_t __Reply __attribute__((unused));
	boolean_t msgh_simple;
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1160) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__authorizationCopyRights_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationCopyRights */
mig_external kern_return_t ucsp_client_authorizationCopyRights
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#ifdef	__MIG_check__Reply__authorizationCopyRights_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationCopyRights_t__defined */

	__DeclareSendRpc(1060, "authorizationCopyRights")
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1060, "authorizationCopyRights")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1060, "authorizationCopyRights")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationCopyRights_t__defined)
	check_result = __MIG_check__Reply__authorizationCopyRights_t((__Reply__authorizationCopyRights_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationCopyRights_t__defined) */
	...
	*result = (Data)(Out0P->result.address);
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationCopyInfo_t__defined)
#define __MIG_check__Reply__authorizationCopyInfo_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationCopyInfo_t(__Reply__authorizationCopyInfo_t *Out0P)
{

	typedef __Reply__authorizationCopyInfo_t __Reply __attribute__((unused));
	boolean_t msgh_simple;
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1161) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__authorizationCopyInfo_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationCopyInfo */
mig_external kern_return_t ucsp_client_authorizationCopyInfo
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#ifdef	__MIG_check__Reply__authorizationCopyInfo_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationCopyInfo_t__defined */

	__DeclareSendRpc(1061, "authorizationCopyInfo")
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->tagCnt = mig_strncpy_zerofill(InP->tag, tag, 1024);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
		InP->tagCnt = mig_strncpy(InP->tag, tag, 1024);
#ifdef USING_MIG_STRNCPY_ZEROFILL
	}
#endif /* USING_MIG_STRNCPY_ZEROFILL */

	msgh_size = (mach_msg_size_t)(sizeof(Request) - 1024) + (_WALIGN_(InP->tagCnt));
	InP->Head.msgh_bits =
		MACH_MSGH_BITS(19, 20);
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = sport;
	InP->Head.msgh_reply_port = rport;
	InP->Head.msgh_id = 1061;
	InP->Head.msgh_reserved = 0;
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1061, "authorizationCopyInfo")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1061, "authorizationCopyInfo")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationCopyInfo_t__defined)
	check_result = __MIG_check__Reply__authorizationCopyInfo_t((__Reply__authorizationCopyInfo_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationCopyInfo_t__defined) */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationExternalize_t__defined)
#define __MIG_check__Reply__authorizationExternalize_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationExternalize_t(__Reply__authorizationExternalize_t *Out0P)
{

	typedef __Reply__authorizationExternalize_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1162) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__authorizationExternalize_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationExternalize */
mig_external kern_return_t ucsp_client_authorizationExternalize
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#ifdef	__MIG_check__Reply__authorizationExternalize_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationExternalize_t__defined */

	__DeclareSendRpc(1062, "authorizationExternalize")
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1062, "authorizationExternalize")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1062, "authorizationExternalize")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationExternalize_t__defined)
	check_result = __MIG_check__Reply__authorizationExternalize_t((__Reply__authorizationExternalize_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationExternalize_t__defined) */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationInternalize_t__defined)
#define __MIG_check__Reply__authorizationInternalize_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationInternalize_t(__Reply__authorizationInternalize_t *Out0P)
{

	typedef __Reply__authorizationInternalize_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1163) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__authorizationInternalize_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationInternalize */
mig_external kern_return_t ucsp_client_authorizationInternalize
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#ifdef	__MIG_check__Reply__authorizationInternalize_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationInternalize_t__defined */

	__DeclareSendRpc(1063, "authorizationInternalize")
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1063, "authorizationInternalize")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1063, "authorizationInternalize")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationInternalize_t__defined)
	check_result = __MIG_check__Reply__authorizationInternalize_t((__Reply__authorizationInternalize_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationInternalize_t__defined) */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__setSessionUserPrefs_t__defined)
#define __MIG_check__Reply__setSessionUserPrefs_t__defined

mig_internal kern_return_t __MIG_check__Reply__setSessionUserPrefs_t(__Reply__setSessionUserPrefs_t *Out0P)
{

	typedef __Reply__setSessionUserPrefs_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1168) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__setSessionUserPrefs_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine setSessionUserPrefs */
mig_external kern_return_t ucsp_client_setSessionUserPrefs
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#pragma pack()
...
#ifdef	__MIG_check__Reply__setSessionUserPrefs_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__setSessionUserPrefs_t__defined */

	__DeclareSendRpc(1068, "setSessionUserPrefs")

#if	UseStaticTemplates
	const static mach_msg_ool_descriptor_t userPrefsTemplate = {
		/* addr = */		(void *)0,
		/* size = */		0,
		/* deal = */		FALSE,
		/* copy = */		MACH_MSG_VIRTUAL_COPY,
	...
	InP->msgh_body.msgh_descriptor_count = 1;
#if	UseStaticTemplates
	InP->userPrefs = userPrefsTemplate;
	InP->userPrefs.address = (void *)(userPrefs);
	InP->userPrefs.size = userPrefsCnt;
#else	/* UseStaticTemplates */
	InP->userPrefs.address = (void *)(userPrefs);
	InP->userPrefs.size = userPrefsCnt;
	InP->userPrefs.deallocate =  FALSE;
	InP->userPrefs.copy = MACH_MSG_VIRTUAL_COPY;
	InP->userPrefs.type = MACH_MSG_OOL_DESCRIPTOR;
#endif	/* UseStaticTemplates */
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1068, "setSessionUserPrefs")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1068, "setSessionUserPrefs")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__setSessionUserPrefs_t__defined)
	check_result = __MIG_check__Reply__setSessionUserPrefs_t((__Reply__setSessionUserPrefs_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__setSessionUserPrefs_t__defined) */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationdbGet_t__defined)
#define __MIG_check__Reply__authorizationdbGet_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationdbGet_t(__Reply__authorizationdbGet_t *Out0P)
{

	typedef __Reply__authorizationdbGet_t __Reply __attribute__((unused));
	boolean_t msgh_simple;
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1171) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#if	__MigTypeCheck
	if (Out0P->rightdefinition.type != MACH_MSG_OOL_DESCRIPTOR) {
		return MIG_TYPE_ERROR;
	}
#endif	/* __MigTypeCheck */
...
#endif /* !defined(__MIG_check__Reply__authorizationdbGet_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationdbGet */
mig_external kern_return_t ucsp_client_authorizationdbGet
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#ifdef	__MIG_check__Reply__authorizationdbGet_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationdbGet_t__defined */

	__DeclareSendRpc(1071, "authorizationdbGet")

	InP->NDR = NDR_record;

#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->rightnameCnt = mig_strncpy_zerofill(InP->rightname, rightname, 1024);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
		InP->rightnameCnt = mig_strncpy(InP->rightname, rightname, 1024);
#ifdef USING_MIG_STRNCPY_ZEROFILL
	}
#endif /* USING_MIG_STRNCPY_ZEROFILL */

	msgh_size = (mach_msg_size_t)(sizeof(Request) - 1024) + (_WALIGN_(InP->rightnameCnt));
	InP->Head.msgh_bits =
		MACH_MSGH_BITS(19, 20);
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = sport;
	InP->Head.msgh_reply_port = rport;
	InP->Head.msgh_id = 1071;
	InP->Head.msgh_reserved = 0;
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1071, "authorizationdbGet")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1071, "authorizationdbGet")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationdbGet_t__defined)
	check_result = __MIG_check__Reply__authorizationdbGet_t((__Reply__authorizationdbGet_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationdbGet_t__defined) */
	...
	*rightdefinition = (Data)(Out0P->rightdefinition.address);
	*rightdefinitionCnt = Out0P->rightdefinitionCnt;
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationdbSet_t__defined)
#define __MIG_check__Reply__authorizationdbSet_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationdbSet_t(__Reply__authorizationdbSet_t *Out0P)
{

	typedef __Reply__authorizationdbSet_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1172) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__authorizationdbSet_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationdbSet */
mig_external kern_return_t ucsp_client_authorizationdbSet
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#pragma pack()
...
#ifdef	__MIG_check__Reply__authorizationdbSet_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationdbSet_t__defined */

	__DeclareSendRpc(1072, "authorizationdbSet")
	...
	InP->msgh_body.msgh_descriptor_count = 1;
#if	UseStaticTemplates
	InP->rightDefinition = rightDefinitionTemplate;
	InP->rightDefinition.address = (void *)(rightDefinition);
	InP->rightDefinition.size = rightDefinitionCnt;
#else	/* UseStaticTemplates */
	InP->rightDefinition.address = (void *)(rightDefinition);
	InP->rightDefinition.size = rightDefinitionCnt;
	InP->rightDefinition.deallocate =  FALSE;
	InP->rightDefinition.copy = MACH_MSG_VIRTUAL_COPY;
	InP->rightDefinition.type = MACH_MSG_OOL_DESCRIPTOR;
#endif	/* UseStaticTemplates */
	...
	msgh_size_delta = _WALIGN_(InP->rightnameCnt);
	msgh_size = (mach_msg_size_t)(sizeof(Request) - 1024) + msgh_size_delta;
	InP = (Request *) ((pointer_t) InP + msgh_size_delta - 1024);

	InP->rightDefinitionCnt = rightDefinitionCnt;
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1072, "authorizationdbSet")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1072, "authorizationdbSet")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationdbSet_t__defined)
	check_result = __MIG_check__Reply__authorizationdbSet_t((__Reply__authorizationdbSet_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationdbSet_t__defined) */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__ucsp_subsystem__
#if !defined(__MIG_check__Reply__authorizationdbRemove_t__defined)
#define __MIG_check__Reply__authorizationdbRemove_t__defined

mig_internal kern_return_t __MIG_check__Reply__authorizationdbRemove_t(__Reply__authorizationdbRemove_t *Out0P)
{

	typedef __Reply__authorizationdbRemove_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 1173) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__authorizationdbRemove_t__defined) */
#endif /* __MIG_check__Reply__ucsp_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine authorizationdbRemove */
mig_external kern_return_t ucsp_client_authorizationdbRemove
(
	mach_port_t sport,
	mach_port_t rport,
	security_token_t *securitydCreds,
...
#ifdef	__MIG_check__Reply__authorizationdbRemove_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__authorizationdbRemove_t__defined */

	__DeclareSendRpc(1073, "authorizationdbRemove")
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(1073, "authorizationdbRemove")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_RCV_TRAILER_TYPE(MACH_MSG_TRAILER_FORMAT_0)|MACH_MSG_OPTION_NONE|MACH_RCV_TRAILER_ELEMENTS(MACH_RCV_TRAILER_SENDER), msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(1073, "authorizationdbRemove")
	if (msg_result != MACH_MSG_SUCCESS) {
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__authorizationdbRemove_t__defined)
	check_result = __MIG_check__Reply__authorizationdbRemove_t((__Reply__authorizationdbRemove_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__authorizationdbRemove_t__defined) */
...
#else	/* UseStaticTemplates */
	InP->hostingPort.name = hostingPort;
	InP->hostingPort.disposition = 20;

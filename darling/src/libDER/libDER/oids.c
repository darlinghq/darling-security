...
__unused const DERItem
    ...
    oidCollectiveOrganizationName   = { (DERByte *)_oidCollectiveOrganizationName,
                                        sizeof(_oidCollectiveOrganizationName) },
    oidCollectiveOrganizationalUnitName = { (DERByte *)_oidCollectiveOrganizationalUnitName,
                                        sizeof(_oidCollectiveOrganizationalUnitName) },
    oidCollectiveStateOrProvinceName  = { (DERByte *)_oidCollectiveStateOrProvinceName,
                                      sizeof(_oidCollectiveStateOrProvinceName) },
    oidStreetAddress                = { (DERByte *)_oidStreetAddress,
                                        sizeof(_oidStreetAddress) },
    oidCollectiveStreetAddress      = { (DERByte *)_oidCollectiveStreetAddress,
                                        sizeof(_oidCollectiveStreetAddress) },
    oidUserId                       = { (DERByte *)_oidUserId,
                                        sizeof(_oidUserId) },
